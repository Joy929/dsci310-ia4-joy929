...
The R programming language was used for the analysis [@R].  
The following R packages were used: `knitr` [@knitr], `tidyverse` [@tidyverse], and Quarto [@Allaire_Quarto_2022].
...
We can see from @fig-horse-pop-all that Ontario, Saskatchewan and Alberta have had the highest horse populations in Canada.
...
Additionally, @fig-horse-pop-all shows standard deviation of historical (1906-1972) horse populations for each Canadian province.
...
Additionally, note that in @tbl-horse-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pop-all.
